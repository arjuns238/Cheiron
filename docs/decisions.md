...
| Contradiction detection | **Judge class 7**, the one fatal verdict → 422 | Deterministic comparison in `apply_overrides`; planner-side | Only the judge reads the question and the plan together. Passed on both providers when added (15/15), and still does (19/19) |
